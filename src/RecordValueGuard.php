...
final class RecordValueGuard
{
    ...
    {
        if ($depth < 0 || $nodes < 0) {
            throw new InvalidArgumentException('A business-record value budget cannot be negative.');
        }
        ++$nodes;
    ...
    /** Normalize an already structurally admitted tree without resetting budgets. */
